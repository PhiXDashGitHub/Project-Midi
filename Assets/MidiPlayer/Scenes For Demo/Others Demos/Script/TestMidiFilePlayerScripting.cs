    ...
    public class TestMidiFilePlayerScripting : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            if (midiFilePlayer != null)
            {
                ...
                GUILayout.Space(20);
                GUILayout.Label(string.Format("Time from start playing {0} / {1}", midiFilePlayer.MPTK_PlayTime, midiFilePlayer.MPTK_RealDuration), myStyle.TitleLabel3, GUILayout.Width(400));
